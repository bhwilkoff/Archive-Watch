...
// MARK: - Going live: the request, and where it resolves to
//
...
// its own binding rule (macOS: proposed §B13g; tvOS: nothing yet — its menu
// arms the Studio and offers no way to choose a platform or title). This file
