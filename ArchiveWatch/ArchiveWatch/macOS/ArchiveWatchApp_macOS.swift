        ...
        WindowGroup("Archive Watch") {
            RootView()
                ...
                .task {
                    ...
                    if CreationStudioBench.isEnabled || CreationStudioFeatureAudit.isEnabled || CreationStudioStress.isEnabled || CreationStudioProjectAudit.isEnabled || CreationStudioTest.mode != nil {
