...
def main() -> int:
    ...
    check("500x781 (3.97% off 2:3) is refused — the tail is where the rejects live", F.aspect_ok(500, 781), False)
    check("500x292 (3.68% off 16:9) is refused", F.aspect_ok(500, 292), False)
    check("500x284 (0.97% off 16:9) is accepted", F.aspect_ok(500, 284), True)
    check("680x1000 (2.0% off 2:3, TheTVDB's native poster) is refused", F.aspect_ok(680, 1000), False)
    check("300x450 (exact 2:3) is accepted", F.aspect_ok(300, 450), True)
