...
def main():
    ...
    # answer 200 today. Acting on it offline would delete working captions.
    # Liveness belongs where the probe is: audit_dead_subtitles, which now
    # re-checks and revives.
