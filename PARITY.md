...
| Browse length filter (Under 60 minutes / 60 to 90 minutes / Over 90 minutes) | ✅ chip row | ✅ Filter menu picker | ✅ Filter menu picker | ✅ select (after index schema 14 publishes) | ✅ phone menu + TV chips | Roku ✅ a fifth chip (318 px step, inside the safe area). Same bands everywhere: `RuntimeBand` / web `LENGTHS` over index column 17 `minutes` |
