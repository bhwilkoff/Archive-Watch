...
| archive.org address or pasted link opens the film (or says it is not here) | ⏳ | ⏳ | ⏳ | ✅ `/details/<id>` + pasted link in search (WEB-DESIGN §4.3b) | ⏳ | Roku ⏳. The apps get the pasted-link half next; aliases resolve through `item_aliases` there |
